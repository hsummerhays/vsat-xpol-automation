...
<node CREATED="1336674444295" ID="ID_1403554808" MODIFIED="1344556573440" TEXT="MSD VSAT Xpol Automation 2012">
<node CREATED="1336674737422" FOLDED="true" ID="ID_383952663" MODIFIED="1344556000039" POSITION="right" TEXT="Purpose">
...
<node CREATED="1344558095184" ID="ID_1037636803" MODIFIED="1344558102048" TEXT="Simple UI">
...
<node CREATED="1344559978028" ID="ID_1661450053" MODIFIED="1344611604557" TEXT="Could use HAL with simple import">
...
<node CREATED="1344560545084" ID="ID_846564828" MODIFIED="1344611690448" TEXT="Later could allow selection of RCSTs in an expanded section">
...
<node CREATED="1344558120231" ID="ID_1841666132" MODIFIED="1344558129998" TEXT="Need to do following">
...
<node CREATED="1343324694522" ID="ID_1925630573" MODIFIED="1344611180170" TEXT="Allow user to select a batch of RCSTs to check and schedule a time">
<node CREATED="1344555746662" ID="ID_150596713" MODIFIED="1344611690448" TEXT="Network - population - set of RCSTs"/>
...
<node CREATED="1345675456250" ID="ID_235768868" MODIFIED="1345675465750" TEXT="Allow deleting RCST list"/>
...
<node CREATED="1344558882283" ID="ID_1549576304" MODIFIED="1344558912401" TEXT="Could import last isolation check data into FileMaker 5.5"/>
</node>
<node CREATED="1344558548022" ID="ID_944179694" MODIFIED="1345743688314" TEXT="VsatXpolBatchMP">
<node CREATED="1344558458043" ID="ID_237984588" MODIFIED="1344558465939" TEXT="Is Windows service"/>
<node CREATED="1344558466675" ID="ID_727734623" MODIFIED="1344558519264" TEXT="Looks for new batches"/>
<node CREATED="1344558520104" ID="ID_369924342" MODIFIED="1344611364150" TEXT="External">
<node CREATED="1345674245211" ID="ID_14421854" MODIFIED="1345674256556" TEXT="Gets power level similar to linkmon">
...
<node CREATED="1343324660644" ID="ID_1193630603" MODIFIED="1343324685756" TEXT="Put RCST into receive only mode and initiate CW">
...
<node CREATED="1343324727352" ID="ID_921100956" MODIFIED="1343324736705" TEXT="Retrieve signal data from RMP"/>
<node CREATED="1336685338259" ID="ID_1985429243" MODIFIED="1344557253904" TEXT="Store data in DB">
...
<node CREATED="1344560352335" ID="ID_1340439713" MODIFIED="1344560363968" TEXT="Abort batch if too many errors"/>
</node>
...
<node CREATED="1345131165045" ID="ID_1182008632" MODIFIED="1345598023465" TEXT="Documentation">
<icon BUILTIN="yes"/>
<node CREATED="1345131169942" ID="ID_644786878" MODIFIED="1345131186048" TEXT="Simply part of VsatXpol system (HAL Wiki)"/>
<node CREATED="1345131187239" ID="ID_324449085" MODIFIED="1345131209006" TEXT="Add information about creating new HAL pages under MonitorPoint Framework">
...
<node CREATED="1345823610115" ID="ID_661057328" MODIFIED="1345823618176" TEXT="Separate from VsatXpol"/>
</node>
<node CREATED="1345823619788" ID="ID_931066978" MODIFIED="1345823690186" TEXT="VsatXpol 1.0.1">
<node CREATED="1345823660277" ID="ID_213491752" MODIFIED="1345823673610" TEXT="Also MainstreamData.Utility 1.0.5">
<node CREATED="1345841928074" ID="ID_1712010865" MODIFIED="1345841943088" TEXT="May need to rerelease to include stringbuilder.clear method"/>
</node>
</node>
<node CREATED="1345823630204" ID="ID_1025687916" MODIFIED="1345823694739" TEXT="VsatXpolBatch 1.0.0">
<node CREATED="1345823645269" ID="ID_141190725" MODIFIED="1345823658662" TEXT="Also MainstreamData.Web 1.0.7"/>
</node>
</node>
</node>
</node>
<node CREATED="1346881968479" ID="ID_786074001" MODIFIED="1346881972793" TEXT="Future Enhancements">
<node CREATED="1346881973634" ID="ID_248631439" MODIFIED="1346881973634" TEXT=""/>
</node>
</node>
<node CREATED="1336748795231" ID="ID_729682713" MODIFIED="1344611793806" POSITION="left" TEXT="VsatXpol Design (no batch related info)">
...
<node CREATED="1336748805142" FOLDED="true" ID="ID_324273489" MODIFIED="1343324878246" TEXT="Components">
<icon BUILTIN="button_ok"/>
<node CREATED="1336754413392" ID="ID_526811411" MODIFIED="1339087394835" TEXT="Windows service on VSAT3RMN (VsatXpolRmpWindowsService)">
<icon BUILTIN="button_ok"/>
